...
Bioinformatics Scientist with expertise in multi-omics data integration and computational biology. Experienced in developing algorithms and workflows for transcriptomics analysis, with a strong background in both research and software development.
...
- Developed an algorithm to annotate and refine de novo transcriptomes

### Scientific Coworker
**Institute of Reconstructive Neurobiology, Bonn, Germany**  
*March 2012 – July 2014*

- Analyzed and developed pipeline for comparative analysis of microarray data from different platforms

### Student Assistant
**Genomics and Immunoregulation, LIMES Institute, Bonn, Germany**  
*October 2010 – January 2012*

- Developed a tool to integrate online metadata of in-house microarray data with its expression data in local hard disks

### Software Engineer
**Jeppiar Technologies Pvt. Ltd, India**  
*November 2008 – July 2009*

- Part of a team that developed web applications using C# and ASP.NET 2.0 framework
...
### Train-Gain Fellowship
**University of Muenster - EMBO practical course at EMBL-EBI, Hinxton, England**  
*October 2014*
...
### Department of Biotechnology's Student Stipend
...
### Training
- Attended EMBO workshop on "Analysis of High Throughput Sequencing data" at EMBL-EBI, Hinxton, England

### Social Skills & Leadership
- Elected as Internal Student Representative in Max Planck PhDnet
- Volunteer at University of Bonn assisting new incoming students
- Elected as School Pupil Leader in St. Mary's Boys Higher Secondary School, India
